...
SSRGScreen_Finish:
		...
		move.b	($200002).l,($FFFFFE12).w	; save emeralds
		move.b	($200300).l,($FFFFFFE1).w	; load Slow Motion state
		move.b	($200302).l,($FFFFFFFA).w	; load Debug Mode state
		move.b	($200038).l,($FFFFFF38).w	; load emerald list state
		move.b	($200058).l,($FFFFFE58).w	; load unknown
		move.b	($200100).l,($FFFF8100).w	; load unlockables
		move.b	#$00,($A130F1).l			; close access to S-Ram
		move.b	#$2C,($FFFFF600).w			; set the screen mode to Main Menu
		rts						; return
